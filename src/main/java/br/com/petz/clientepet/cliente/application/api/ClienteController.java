...
public class ClienteController implements ClienteAPI {
	...
	public List<ClienteListResponse> getTodosClientes() {
		log.info("[iniciar] ClienteController - getTodosClientes");
	...
	public ClienteDetalhadoResponse getclientesAtravesId(UUID idCliente) {
		log.info("[iniciar] ClienteController - getclientesAtravesId");
	...
	public void deletaClientesAtravesId(UUID idCliente) {
		log.info("[iniciar] ClienteController - deletaClientesAtravesId");
		log.info("[idCliente] {}", idCliente);
